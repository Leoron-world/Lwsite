...
//             <br />
//             Aspiring to become tshe 1st metaverse company catering to India's unique needs in sports, starting with Cricket and Football.
//           </animated.p>

//           <div className="mt-12">
//             <button className="px-4 mt-1 py-1 bg-green-700 text-white rounded-xl font-serif tracking-tighter text-xl">
//               Know More
//             </button>
    ...
    <>
      <div className="grid grid-cols-2 ">
        <div>
          ...
          {/* <h1 className="text-green-500 p-4"> Welcome to the Leoron World</h1> */}
          <p className="text-xl p-4 text-neutral-400">
            Building a digital world devoted to sports.
            <br />
            An immersive digital platform to celebrate sporting rivalries among
            fans through virtual territories of clubs/teams.
            <br />
            Aspiring to become tshe 1st metaverse company catering to India's
            unique needs in sports, starting with Cricket and Football.
          </p>

          <div className="flex items-center  gap-4 p-4">
            <Button className="h-1/2">Know More</Button>
